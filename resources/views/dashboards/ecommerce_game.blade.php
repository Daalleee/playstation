...
@section('title', 'Games - PlayStation Rental')
...
<div class="container">
    ...
    <section class="hero-section rounded-3">
        <div class="container text-center">
            <h1 class="display-5 fw-bold mb-3">Game PlayStation Tersedia</h1>
            <p class="lead">Temukan game favoritmu untuk pengalaman bermain terbaik</p>
        </div>
    </section>

    <form method="GET" action="{{ route('pelanggan.games.index') }}" class="mb-4">
        <div class="position-relative">
            <input type="text" name="q" class="form-control form-control-lg search-input" placeholder="Cari game..." value="{{ request('q') }}" onkeypress="handleSearchKeyPress(event, this.form)">
