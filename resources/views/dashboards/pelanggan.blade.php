...
<style>
  ...
  .dash-sidebar{ flex:0 0 280px; background:#3a2a70; border-radius:1rem; padding:1.25rem 1rem; box-shadow:0 1rem 2rem rgba(0,0,0,.25); min-height:calc(100dvh - 2rem); position:sticky; top:1rem; }
