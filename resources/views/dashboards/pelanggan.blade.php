  ...
  <div class="dash-layout">
    ...
    <main class="dash-main">
      <div class="dash-hero">
        ...
        <p>Temukan PlayStation favoritmu, game seru, dan aksesoris lengkap untuk pengalaman bermain terbaik!</p>
      </div>

      <!-- Unit PS Section -->
      <section class="mb-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h3>Unit PlayStation</h3>
          <a href="{{ route('pelanggan.unitps.index') }}" class="btn btn-cta">Lihat Semua</a>
        </div>
      ...
      <section class="mb-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h3>Games</h3>
          <a href="{{ route('pelanggan.games.index') }}" class="btn btn-cta">Lihat Semua</a>
        </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 px-2">
              ...
              <div class="dash-card">
                ...
                <div class="card-content">
                  <div class="p-2 flex-grow-1">
                    ...
                    <div class="text-center text-light mb-1">{{ $game->platform }}</div>
      ...
      <section class="mb-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h3>Aksesoris</h3>
          <a href="{{ route('pelanggan.accessories.index') }}" class="btn btn-cta">Lihat Semua</a>
        </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 px-2">
            ...
            <div class="col">
              <div class="dash-card">
                <div class="dash-frame">
                  ...
                  @else
                    <img src="https://placehold.co/300x200/49497A/FFFFFF?text=Aksesoris" alt="{{ $acc->nama }}" class="img-fluid">
                  @endif
                </div>
                <div class="card-content">
                  <div class="p-2 flex-grow-1">
                    <h5 class="mb-1 text-center text-white fw-bold">{{ $acc->nama }}</h5>
                    <div class="fw-bold text-price mb-1 text-center mt-2">Rp {{ number_format($acc->harga_per_hari, 0, ',', '.') }}/hari</div>
                    <div class="text-center">Stok: {{ $acc->stok }}</div>
                  </div>
                  <div class="pt-2 mt-auto">
                    <a href="{{ route('pelanggan.rentals.create') }}?type=accessory&id={{ $acc->id }}" class="btn btn-cta w-100">Sewa Aksesoris</a>
                  </div>
                </div>
              </div>
            </div>
          @empty
            <div class="col-12 text-center">
              <p>Tidak ada aksesoris tersedia saat ini.</p>
            </div>
          @endforelse
        </div>
      </section>
