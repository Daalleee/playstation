    ...
    <div class="card p-3">
        <form method="POST" action="{{ route('admin.unitps.update', $unit) }}" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nomor_seri" value="{{ old('nomor_seri', $unit->nomor_seri) }}" required class="form-control" pattern="[0-9]+" title="Nomor seri hanya boleh berisi angka" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="Contoh: 123456789">
